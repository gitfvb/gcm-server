...
var corsOptions = {
  origin: 'https://shop.apteco-faststats.de',
...
function _startServer() {
    ...
    for (entryPoint in this.entryPoints)
	    this.app.use(this.entryPoints[entryPoint], cors(corsOptions), _handleEntryPoint[entryPoint+'Handler'].bind(this));
	...
	*/
	httpsServer.listen(8443, function() {
        console.log('CORS-enabled Server listening on port', 8443);
    });
	/*
